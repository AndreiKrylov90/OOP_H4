...
public class program {
    public static void main(String[] args) throws Exception {
        ...
        Teacher teacher0 = new Teacher(0, "Ivan", "Petrov", "?!", LocalDate.now());
        Teacher teacher1 = new Teacher(1, "Petr", "Ivanov", "?!", LocalDate.now());
        Teacher teacher2 = new Teacher(2, "Genadiy", "Sidorov", "?!", LocalDate.now());
        Teacher teacher3 = new Teacher(3, "Pavel", "Tretyakov", "?!", LocalDate.now());
        Teacher teacher4 = new Teacher(4, "Maria", "Kosova", "?!", LocalDate.now());
        Teacher teacher5 = new Teacher(5, "Svetlana", "Pervaya", "?!", LocalDate.now());
